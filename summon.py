...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.entry = customtkinter.CTkEntry(
            self,
            placeholder_text="Enter an idea...",
            width=220,
        ...
        self.rerate_button = customtkinter.CTkButton(
            self,
            text="Rerate",
            width=1,
            font=("Calibri Light", 20),
        ...
        self.rerate_button.grid(
            column=2, row=0, padx=(10, 10), pady=(10, 10), sticky="e"
        )
        ...
        self.listbox1.bind(
            "<Double-BackSpace>", lambda x: self.remove_idea(self.listbox1)
        )
        self.listbox2.bind(
            "<Double-BackSpace>", lambda x: self.remove_idea(self.listbox2)
        )
        self.listbox3.bind(
            "<Double-BackSpace>", lambda x: self.remove_idea(self.listbox3)
        )
    ...
    def save(self):
        ...
        list3_df.sort_values(
            by=["cost", "influence"], ascending=[False, False], inplace=True
        )
